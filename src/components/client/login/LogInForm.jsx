...
function LogInForm() {
  const { userDetails, setUserDetails, handleLogin } = useContext(UserContext);

  return (
    <section className="bg-gray-50 dark:bg-gray-900  h-full  ">
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 h-full max-w-lg">
        <a
          href="#"
          className="flex items-center mb-console.log(userDetails);6 text-2xl font-semibold text-gray-900 dark:text-white"
        >
          <img
